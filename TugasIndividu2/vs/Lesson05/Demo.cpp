...
void Demo::Render() {
	...
	glm::mat4 view = glm::lookAt(glm::vec3(posCamX, 7 , posCamZ), glm::vec3(viewCamX, viewCamY, viewCamZ), glm::vec3(upCamX, upCamY, upCamZ));
...
int main(int argc, char** argv) {
	...
	app.Start("Transformation: Transform Table", 800, 600, false, false);	
}